...
_TD.a.push(function (TD) {
	...
	TD._msg_texts = {
		...
		"building_name_ice_gun": "冰冻枪",
		"building_info": "${0}: 等级 ${1}，攻击 ${2}，速度 ${3}，射程 ${4}，战绩 ${5}",
		"man_info_man":  "${0}: 等级 ${1}，攻击 ${2}，速度 ${3}，射程 ${4}，战绩 ${5}",
